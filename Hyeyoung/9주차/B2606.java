...
public class B2606
{
    public static void main(String[] args) throws IOException
    {
        ...
        List<Integer>[] edges = new List[computerCount + 1];
        ...
        int infectedCount = bfs(1, computerCount, edges);
        System.out.println(infectedCount);
    }

    private static int bfs(int startComputer, int computerCount, List<Integer>[] edges)
    {
        ...
        while (!q.isEmpty())
        {
            ...
            for (int nextNode: edges[current])
            {
                if (!visited[nextNode])
                {
                    ...
                    visitedCount++;
                    //System.out.println("infected " + nextNode);
                }
            }
        }
        return visitedCount;
